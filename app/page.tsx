...
const stats = [
  ...
  { value: "<50ms", label: "Monitoring latency", color: "text-rose-600 dark:text-rose-400" },
  { value: "12,000+", label: "Developer teams", color: "text-pink-600 dark:text-pink-400" },
  { value: "4B+", label: "Requests tracked daily", color: "text-fuchsia-600 dark:text-fuchsia-400" },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden border-b border-border/50">
        <div className="absolute inset-0 -z-10 overflow-hidden">
          ...
          <div className="absolute -top-20 right-1/4 h-[500px] w-[500px] rounded-full bg-rose-400/20 blur-3xl" />
          <div className="absolute top-60 left-1/2 h-[400px] w-[700px] rounded-full bg-fuchsia-400/15 blur-3xl" />
        </div>
        <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:py-40">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl lg:text-7xl">
              Monitor your APIs{" "}
              <span className="bg-gradient-to-r from-pink-600 via-rose-500 to-fuchsia-400 bg-clip-text text-transparent">
                with confidence
              </span>
            </h1>
                ...
                <div className="space-y-2 font-mono text-xs">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 text-muted-foreground">
                      <span className={`w-12 text-center rounded px-1.5 py-0.5 text-[10px] font-semibold ${req.method === "GET" ? "bg-pink-100 text-pink-700 dark:bg-pink-900/30 dark:text-pink-400" :
                          req.method === "POST" ? "bg-pink-100 text-pink-700 dark:bg-pink-900/30 dark:text-pink-400" :
